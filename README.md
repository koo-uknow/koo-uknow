...
### Patents
- 단일 이미지 기반 포인트 클라우드 정합을 통한 6자유도 자세 추정 방법 및 장치
  - 출원 번호: 10-2025-0106350
  - 설명: 단일 2D RGB 이미지를 이용하여 Point Cloud를 생성하고, 생성된 Point Cloud를 정합하여 객체의 6D Pose를 추정하는 아키텍쳐

- 기하-의미 융합 정제를 이용하여 일반화 퓨샷 3차원 포인트 클라우드 분할을 수행하는 전자장치 및 그 동작 방법
  - 출원 번호: 10-2026-0061528
  - 설명: 슈퍼복셀을 활용하여 기하학적 정보를 추출, VLM을 활용하여 의미론적 정보를 추출하여 결합 해 3D 포인트 클라우드 분할을 수행하는 소프트웨어
  
### Program Registrations
- 슈퍼복셀 기반 기하학적 정제 및 교사-학생 증류를 이용한 일반화 퓨샷 3D 포인트 클라우드 분할
  - 등록 번호: C-2026-001495
  - 설명: 슈퍼복셀을 활용하여 기하학적 정보를 추출, VLM을 활용하여 의미론적 정보를 추출하여 결합 해 3D 포인트 클라우드 분할을 수행하는 소프트웨어
